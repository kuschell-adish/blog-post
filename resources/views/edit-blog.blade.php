        ...
        <div class="bg-white rounded-lg p-10 shadow">
            ...
            @endauth
                ...
                <div class="mt-10">
                    ...
                    <div class="mt-2">
                        <textarea id="body" name="body" rows="4" class="pl-2 block p-2.5 w-full text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">{{$blog->body}}</textarea>
                    </div>
                </div>
